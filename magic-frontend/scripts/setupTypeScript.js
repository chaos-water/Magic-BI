...
// mv src/main.js to main.ts - note, we need to edit rollup.js.js for this too
...
// Edit rollup js
const rollupConfigPath = path.join(projectRoot, "rollup.js.js")
...
`
const svelteConfigPath =  path.join(projectRoot, "svelte.js.js")
